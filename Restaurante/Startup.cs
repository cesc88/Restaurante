...
using Restaurante.Application.Mapper;
...
namespace Restaurante
{
    public class Startup
    {
        ...
        {
            Bootstrap.ServiceRegister(services, Configuration);
            ...
            {
                x.SwaggerDoc(name: "v1", new OpenApiInfo { Title = "Restaurante", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(x =>
            {
                x.SwaggerEndpoint(url: "/swagger/v1/swagger.json", name: "Api para Restaurante");
            });
